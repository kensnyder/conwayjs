...
<?php echo $this->Form->create('GameShape'); ?>
	<fieldset>
		<legend><?php echo __('Edit Game Shape'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GameShape.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GameShape.id'))); ?></li>
